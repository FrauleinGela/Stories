## SSR , benefits, and ways how to use it

Displays the top 10 stories sorted in ascending order by their score 
<br>
App made with Nuxt v4 and structured using a modular approach, making the codebase organized.
